...
{
    public async Task<IEnumerable<Domain.Model.LegalCase>> Handle(GetAllLegalCasesQuery query)
    {
        return await legalCaseRepository.ListAsync();
    }
    ...
    public async Task<IEnumerable<Domain.Model.LegalCase>> Handle(GetLegalCaseByStatusQuery query)
    {
